...
WebGL layers are ideal for:
- Large datasets (1000+ features)
- Data visualizations
- Smooth animations
- Advanced styling with expressions

See the [WebGL Demo](/docs/demo-webgl) for a live example.
...
- See the [WebGL Demo](/docs/demo-webgl) for high-performance rendering
- Explore the [Layers API](/docs/api-layers) for detailed layer documentation
